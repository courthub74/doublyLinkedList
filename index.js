...
class DoublyLinkedList {
  ...
  push(val) {
    //create var 'newNode' and set it to the Node value
    const newNode = new Node(val);
    //if there is no Head value
    if (!this.head) {
      //set the newNode to the head value
      this.head = newNode;
      //and always set it to the tail
      this.tail = newNode;
    } else {
      //else
      //set the next tail value as the newNode
      this.tail.next = newNode;
      //set prev newNode value as the tail
      newNode.prev = this.tail;
      //set the new tail value to the newNode value
      this.tail = newNode;
    }
